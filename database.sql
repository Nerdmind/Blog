-- =============================================================================
-- Table structure for category items
-- =============================================================================
CREATE TABLE `category` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `slug` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
-- =============================================================================
ALTER TABLE `category` ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `time_insert` (`time_insert`), ADD UNIQUE KEY `slug` (`slug`);
...
-- =============================================================================
ALTER TABLE `category` MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT;
